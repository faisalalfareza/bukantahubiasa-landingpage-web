                ...
                <div class="modal-body">
                 <section class="modal-body">  
                  ...
                  <div class="popup_login user_login">
                   ...
                   <div class="centeredText ruleterms">
                     <span>By logging in, you agree to Bukantahubiasa's <a href="#">Terms of Service</a>, <a href="#">Cookie Policy</a>, <a href="#">Privacy Policy</a> and <a href="#">Content Policies</a>.</span>
                   </div> 
                     <div class="action_btns">
                  ...
                  <div class="popup_login user_register">
                   ...
                   <div class="centeredText ruleterms">
                     <span>By registering, you agree to Bukantahubiasa's <a href="#">Terms of Service</a>, <a href="#">Cookie Policy</a>, <a href="#">Privacy Policy</a> and <a href="#">Content Policies</a>.</span>
                   </div> 
                     <div class="action_btns">
                 ...
                 <div class="popup_login forgot">
                  <form action="<?php echo base_url()."index.php/auth/requestforget"?>" method="post" id="formRecover" onsubmit="return false">
                   <div class="form-group">
                     <label class="control-label" for="inputDefault">Email</label>
                     <input id="recUser" type="email" name="UserEmail" class="form-control" placeholder="contoh : neogeeks@mail.com" autofocus>
                   </div>         
                   <div class="action_btns">
