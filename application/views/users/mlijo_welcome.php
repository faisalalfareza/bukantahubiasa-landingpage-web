            ...
            <div class="header-content">        
               <nav class="site-nav">
                  <ul class="clean-list site-links">
                      ...
                      <a href="<?=site_url('index.php/tambahpengalaman')?>" class="btn btn-white">Kerjasama</a>
               ...
               <div class="container">
                  <div class="hero-text align-center">
                    <div class="col-md-12 first">
                     ...
                     <div class="title">
                     Selalu ada memberikan anda pengalaman kuliner dan cita rasa yang terbaik. Kenikmatan anda adalah kepuasaan dari kami</div>
                     ...
                     <div class="quote" style="margin-top:0.8em;">
                        <span style="background-color:#fdfdfd;padding:5px;box-shadow: 2px 2px 15px rgba(52, 52, 52, 0.15);border-radius:3px;color:#f39c12;margin:0.01em;">1</span>
                        <span style="color:white;margin:0.01em;">,</span>
                        <span style="background-color:#fdfdfd;padding:5px;box-shadow: 2px 2px 15px rgba(52, 52, 52, 0.15);border-radius:3px;color:#f39c12;margin:0.01em;">1</span>
                         <span style="background-color:#fdfdfd;padding:5px;box-shadow: 2px 2px 15px rgba(52, 52, 52, 0.15);border-radius:3px;color:#f39c12;margin:0.01em;">3</span>
                         <span style="background-color:#fdfdfd;padding:5px;box-shadow: 2px 2px 15px rgba(52, 52, 52, 0.15);border-radius:3px;color:#f39c12;margin:0.01em;">2</span>
